...
//        fragmentTransaction.addToBackStack(fragment.getClass().getName());
    ...
    private void switchHome() {
        views.Navigation_btn_1_icon.setBackgroundResource(R.drawable.btn_home_press);
        views.Navigation_btn_2_icon.setBackgroundResource(R.drawable.btn_disclose_normal);
        views.Navigation_btn_3_icon.setBackgroundResource(R.drawable.btn_profile_nomal);
        switchView(new HomeFragment());
    }

    private void switchDisclose() {
        views.Navigation_btn_1_icon.setBackgroundResource(R.drawable.btn_home_normal);
        views.Navigation_btn_2_icon.setBackgroundResource(R.drawable.btn_disclose_press);
        views.Navigation_btn_3_icon.setBackgroundResource(R.drawable.btn_profile_nomal);
    ...
    private void switchProfile() {
        views.Navigation_btn_1_icon.setBackgroundResource(R.drawable.btn_home_normal);
        views.Navigation_btn_2_icon.setBackgroundResource(R.drawable.btn_disclose_normal);
        views.Navigation_btn_3_icon.setBackgroundResource(R.drawable.btn_profile_press);
