...
public class DiscussAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if(convertView == null){
            convertView = mInflater.inflate(R.layout.item_discuss_detail, parent, false);
    ...
    private class ViewHolder{
        private CustomShapeImageView Iv_Photo;
        private TextView Tv_NickName, Tv_Time, Tv_Content;
        public ViewHolder(View view){
            Iv_Photo = (CustomShapeImageView) view.findViewById(R.id.item_discuss_detail_photo);
            Tv_NickName = (TextView) view.findViewById(R.id.item_discuss_detail_nickname);
            Tv_Time = (TextView) view.findViewById(R.id.item_discuss_detail_time);
            Tv_Content = (TextView) view.findViewById(R.id.item_discuss_detail_content);
        }
    }
}
